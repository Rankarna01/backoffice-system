...
class QuizzesRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'Kuis / Evaluasi Modul';

    protected static ?string $modelLabel = 'Kuis Modul';

    protected static ?string $pluralModelLabel = 'Kuis-Kuis Modul';
